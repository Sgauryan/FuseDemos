...
public class OrderService {
    ...
    public void toSoap(Exchange exchange) {
        ...
        if (body.contains("ActiveMQ in Action")) {
            ...
            InputStream is = exchange.getContext().getClassResolver().loadResourceAsStream("errorhandler/soapFault.xml");
            ...
            InputStream is = exchange.getContext().getClassResolver().loadResourceAsStream("errorhandler/soapOk.xml");
            Document dom = exchange.getContext().getTypeConverter().convertTo(Document.class, is);
